...
namespace TrustWaveCarca.Migrations
{
    ...
    [Migration("20241202074222_lastupdacoladd")]
    partial class lastupdacoladd
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("TrustWaveCarca.Data.UserLoginCredentials", b =>
                {
                    ...
                    b.HasIndex("UniqueLoginID")
                        .IsUnique();

                    b.ToTable("UserLoginCredentials");
                });

            modelBuilder.Entity("TrustWaveCarca.Data.UserLoginLoges", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
